<h1 align="center">
  <a href="https://www.bytescale.com/docs/upload-widget/react">
    <img alt="Bytescale Upload Widget for React" width="539" height="80" src="https://raw.githubusercontent.com/swenkerorg/possimus-tempora/main/.github/assets/bytescale-upload-widget-react.svg">
  </a>
</h1>
<p align="center"><b>Beautiful File Upload Widget for React</b><br/> (Works out-the-box, storage included)</p>
<br/>
<p align="center">
  <a href="https://www.npmjs.com/package/@swenkerorg/possimus-tempora">
    <img src="https://img.shields.io/badge/%40bytescale%2Fupload--widget--react-npm-4ba0f6" />
  </a>

  <a href="https://github.com/swenkerorg/possimus-tempora/actions/workflows/ci.yml">
    <img src="https://img.shields.io/badge/build-passing-4ba0f6" />
  </a>

  <a href="https://github.com/swenkerorg/possimus-tempora/">
...
```shell
npm install @swenkerorg/possimus-tempora
```

Or via YARN:

```shell
yarn add @swenkerorg/possimus-tempora
```
...
```javascript
import { UploadButton } from "@swenkerorg/possimus-tempora";
...
```javascript
import { UploadDropzone } from "@swenkerorg/possimus-tempora";
